...
import java.net.URL;
public class NGODonationHistoryTest {
  ...
  @Test
  public void nGODonationHistory() {
    ...
    driver.findElement(By.id("form2Example17")).sendKeys("rj@");
    driver.findElement(By.id("form2Example17")).sendKeys(Keys.ENTER);
    ...
    driver.findElement(By.cssSelector(".donation-history-btn")).click();
    assertThat(driver.switchTo().alert().getText(), is("Error: NGO not found"));
    driver.close();
  }
}
