...
import java.net.URL;
public class NGOUpdateProfileTest {
  ...
  public void nGOUpdateProfile() {
    ...
    driver.findElement(By.cssSelector(".update-ngo-h3")).click();
    assertThat(driver.findElement(By.cssSelector(".update-ngo-h3")).getText(), is("Update NGO Profile"));
    driver.close();
  }
}
